        ...
        return [
            {
              ...
              "image": require("../../assets/images/hotels/legend_hotel/0.png"),
              "display_images": [
                require("../../assets/images/hotels/legend_hotel/4.png"),
                require("../../assets/images/hotels/legend_hotel/1.png"),
                require("../../assets/images/hotels/legend_hotel/2.png"),
                require("../../assets/images/hotels/legend_hotel/3.png"),
              ],
            ...
            },
            {
              ...
              "image": require("../../assets/images/hotels/marriot/0.png"),
              "display_images": [
                require("../../assets/images/hotels/marriot/4.png"),
                require("../../assets/images/hotels/marriot/1.png"),
                require("../../assets/images/hotels/marriot/2.png"),
                require("../../assets/images/hotels/marriot/3.png"),
              ],
            ...
            },
            {
              ...
              "image": require("../../assets/images/hotels/radisson/0.png"),
              "openingDays": {
                "Monday": true,
                "Tuesday": true,
                "Wednesday": true,
              ...
              'display_images': [
                require('../../assets/images/hotels/radisson/1.png'),
                require('../../assets/images/hotels/radisson/2.png'),
                require('../../assets/images/hotels/radisson/3.png')
              ],
